...
impl eframe::App for BunkaGuiApp {
    fn ui(&mut self, ui: &mut egui::Ui, _frame: &mut eframe::Frame) {
        ...
        custom_frame.show(ui, |ui| {
            ...
            ui.horizontal(|ui| {
                ui.label(
                    egui::RichText::new("Decimal:").color(egui::Color32::from_rgb(200, 200, 210)),
                );
            ...
            ui.horizontal(|ui| {
                ui.label(
                    egui::RichText::new("Max Denom:").color(egui::Color32::from_rgb(170, 170, 180)),
                );
            ...
            ui.horizontal(|ui| {
                ui.label(
                    egui::RichText::new("Tolerance:").color(egui::Color32::from_rgb(170, 170, 180)),
                );
                ui.add(
                    egui::Slider::new(&mut self.tolerance_exp, -9..=-1)
                        .show_value(true)
                        .text("10^x"),
                );
            });
            ...
            ui.vertical_centered(|ui| {
                ...
                ui.with_layout(
                    ...
                    |ui| {
                        ...
                        let copy_btn = ui.add(
                            egui::Button::new(
                                egui::RichText::new("Copy").font(egui::FontId::proportional(12.0)),
                            )
                            .frame(true),
                        );
                        if copy_btn.clicked() {
                            ui.ctx()
                                .copy_text(format!("{}/{}", self.numerator, self.denominator));
                        }
                    },
                );
            });
