...
- **`README.md` / `README.ja.md` の更新**:
  ビルド・実行手順、依存ライブラリの追加、設定手順に変更があった場合は、必ず英語・日本語双方のドキュメントに反映すること。また、各READMEのタイトル直下にCIビルドやライセンス等のステータスバッジを追加・維持すること。さらに、英語版には日本語版へのリンク（`README.ja.md`）、日本語版には英語版へのリンク（`README.md`）がタイトル直下のバッジ付近に正しく設置されていることを必ず確認すること。
